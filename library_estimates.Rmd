...
#At
At_N <- C*G/L
print(paste('number of reads for At WGS:', as.character(format(N, scientific=T)))) #3 million reads required for 1 sample at 30x coverage 
...
#At
N_At <- Nano_standard_C*ideal_bp/L #using the human nanoseq coverage, calculate required reads to achieve comprable coverage 
